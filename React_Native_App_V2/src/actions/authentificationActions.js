...
export function login(userCredentials) {
    ...
    for (let user of userList) {
        if (userCredentials.userName === user.UserName && userCredentials.password === user.Password && user.Role === "Admin") {
            return {
                type: LOGIN_SUCCESS_ADMIN
            }
        }
        else if (userCredentials.userName === user.UserName && userCredentials.password === user.Password && user.Role === "User") {
            return {
